...
public class Topic_15_Wait_Part_IV_Mixing_Fluent_Wait {
	...
	public void TC_04_Upload_ExplicitWait() throws InterruptedException {
		...
		explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[contains(text(),'songoku1.jpg')]")));
		explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[contains(text(),'songoku2.jpg')]")));
		explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[contains(text(),'songoku3.jpg')]")));
		...
		explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@href,'songoku1.jpg')]")));
